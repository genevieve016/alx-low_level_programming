...
/**
 * create_buffer - create buffer allocated 1024 bytes
 * @file: name of file that buffer is storing the chars for
 *
 ...
 * @argv: array of pointers to the arguments @argc
 *
 * Return: 0 (Success)
 *
 * desc: if the number of argument is not the correct one, exit with code 97
